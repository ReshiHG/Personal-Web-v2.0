  ...
  return (
    <>
      <nav className="sticky top-0 h-16 w-full bg-jr-negro-a-900 text-white">
        <div className="container mx-auto gap-8 md:flex md:justify-around">
          <div className="relative z-10 flex items-center bg-jr-negro-a-900 p-3 md:flex md:gap-8">
          ...
          <div
            className={`absolute top-0 right-0 left-0 flex h-[calc(100vh-64px)] origin-top flex-col justify-center bg-jr-negro-a-900 p-3 transition-all duration-500 ease-in-out md:static md:h-auto md:flex-row md:items-center md:gap-3 ${
              isOpen
                ? "pointer-events-auto translate-y-16 opacity-100 md:translate-y-0"
